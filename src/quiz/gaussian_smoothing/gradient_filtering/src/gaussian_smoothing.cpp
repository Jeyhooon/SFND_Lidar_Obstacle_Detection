...
void gaussianSmoothing1()
{
    ...
    int gauss_data_size = sizeof(gauss_data) / sizeof(gauss_data[0]);
    float sum_gauss_data = accumulate(gauss_data, gauss_data + gauss_data_size, 0.0);
    kernel = kernel / sum_gauss_data;
